...
//86671155
const unsigned char SystemConfig_CTIHelpTel1[16]         @SystemConfig_Addr+0x60={8,6,6,7,1,1,5,5,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff};
const unsigned char SystemConfig_CTIHelpTel2[16]         @SystemConfig_Addr+0x70={8,6,6,7,1,1,5,5,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff};
const unsigned char SystemConfig_CTIHelpTel3[16]         @SystemConfig_Addr+0x80={8,6,6,7,1,1,5,5,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff};
const unsigned char SystemConfig_CTIHelpTel4[16]         @SystemConfig_Addr+0x90={8,6,6,7,1,1,5,5,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff};
...
//86671142
const unsigned char SystemConfig_CTIDataTel1[16]         @SystemConfig_Addr+0xA0={8,6,6,7,1,1,4,2,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff};
const unsigned char SystemConfig_CTIDataTel2[16]         @SystemConfig_Addr+0xB0={8,6,6,7,1,1,4,2,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff};
const unsigned char SystemConfig_CTIDataTel3[16]         @SystemConfig_Addr+0xC0={8,6,6,7,1,1,4,2,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff};
const unsigned char SystemConfig_CTIDataTel4[16]         @SystemConfig_Addr+0xD0={8,6,6,7,1,1,4,2,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff};
